...
- [x] 1.5 Commit: `feat: add lastUpdated export to generated aine-classification`
...
- [x] 2.6 Commit: `feat: update README last-updated marker from generation script`
...
- [x] 3.4 Commit: `refactor: restructure README with live URL, data freshness, and dev setup section`
...
- [x] 5.1 Push the branch to remote
- [x] 5.2 Create pull request via `gh pr create`
