...
- [x] 1.5 Commit: `fix: set html lang to es-ES and add og:locale metadata`
...
- [x] 2.3 Commit: `feat: add visible AEMPS attribution`
...
- [x] 3.5 Commit: `feat: add Spanish aria-labels to search form`
...
- [x] 4.4 Commit: `test: add e2e tests for lang, attribution, and accessibility`
