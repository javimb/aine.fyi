...
Vercel Analytics provides cookieless traffic tracking for the application, collecting page views, visitors, referrers, and demographics data visible in the Vercel Dashboard.
