...
A reusable presentational component that renders the ⚠️ Unicode character as a purely visual indicator with accessibility attributes that prevent screen reader announcement.
