...
A web application that helps people with NSAID (AINE) allergies check whether commercial medications contain NSAID compounds. It queries the [CIMA API](https://cima.aemps.es/) (Agencia Española de Medicamentos y Productos Sanitarios) and displays results via a color-coded risk indicator:
